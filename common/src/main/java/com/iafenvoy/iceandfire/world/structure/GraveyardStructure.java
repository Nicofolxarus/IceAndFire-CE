...
public class GraveyardStructure extends IafJigsawStructure {
    ...
    public GraveyardStructure(Config config, RegistryEntry<StructurePool> startPool, Identifier startJigsawName, int size, HeightProvider startHeight, Heightmap.Type projectStartToHeightmap, int maxDistanceFromCenter) {
