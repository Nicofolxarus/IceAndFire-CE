...
public class GorgonTempleStructure extends IafJigsawStructure {
    public static final MapCodec<GorgonTempleStructure> CODEC = RecordCodecBuilder.<GorgonTempleStructure>mapCodec(instance ->
    ...
    protected Optional<StructurePosition> getStructurePosition(Context pContext) {
        if (!IafCommonConfig.INSTANCE.gorgon.generateTemple.getValue()) return Optional.empty();
