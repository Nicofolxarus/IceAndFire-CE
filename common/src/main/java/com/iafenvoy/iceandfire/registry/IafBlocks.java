...
public final class IafBlocks {
    ...
    public static final RegistrySupplier<Block> MYRMEX_DESERT_RESIN = register(BlockMyrmexResin.name(false, "desert"), () -> new BlockMyrmexResin(false));
    public static final RegistrySupplier<Block> MYRMEX_DESERT_RESIN_STICKY = register(BlockMyrmexResin.name(true, "desert"), () -> new BlockMyrmexResin(true));
    public static final RegistrySupplier<Block> MYRMEX_JUNGLE_RESIN = register(BlockMyrmexResin.name(false, "jungle"), () -> new BlockMyrmexResin(false));
    public static final RegistrySupplier<Block> MYRMEX_JUNGLE_RESIN_STICKY = register(BlockMyrmexResin.name(true, "jungle"), () -> new BlockMyrmexResin(true));
    public static final RegistrySupplier<Block> DESERT_MYRMEX_COCOON = register("desert_myrmex_cocoon", BlockMyrmexCocoon::new);
    public static final RegistrySupplier<Block> JUNGLE_MYRMEX_COCOON = register("jungle_myrmex_cocoon", BlockMyrmexCocoon::new);
    public static final RegistrySupplier<Block> MYRMEX_DESERT_BIOLIGHT = register("myrmex_desert_biolight", BlockMyrmexBiolight::new);
    public static final RegistrySupplier<Block> MYRMEX_JUNGLE_BIOLIGHT = register("myrmex_jungle_biolight", BlockMyrmexBiolight::new);
    public static final RegistrySupplier<Block> MYRMEX_DESERT_RESIN_BLOCK = register(BlockMyrmexConnectedResin.name(false, false), () -> new BlockMyrmexConnectedResin(false, false));
    public static final RegistrySupplier<Block> MYRMEX_JUNGLE_RESIN_BLOCK = register(BlockMyrmexConnectedResin.name(true, false), () -> new BlockMyrmexConnectedResin(true, false));
    public static final RegistrySupplier<Block> MYRMEX_DESERT_RESIN_GLASS = register(BlockMyrmexConnectedResin.name(false, true), () -> new BlockMyrmexConnectedResin(false, true));
    public static final RegistrySupplier<Block> MYRMEX_JUNGLE_RESIN_GLASS = register(BlockMyrmexConnectedResin.name(true, true), () -> new BlockMyrmexConnectedResin(true, true));
