...
public final class IafArmorMaterials {
    ...
    public static final RegistrySupplier<ArmorMaterial> MYRMEX_JUNGLE_ARMOR_MATERIAL = register("myrmex_jungle", new int[]{3, 5, 8, 4}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0, new MemorizeSupplier<>(() -> Ingredient.ofItems(IafItems.MYRMEX_JUNGLE_CHITIN.get())));
