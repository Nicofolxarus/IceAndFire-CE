...
public final class IafItems {
    ...
    public static final RegistrySupplier<Item> SILVER_HELMET = register("armor_silver_metal_helmet", () -> new ArmorItem(IafArmorMaterials.SILVER_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings()));
    public static final RegistrySupplier<Item> SILVER_CHESTPLATE = register("armor_silver_metal_chestplate", () -> new ArmorItem(IafArmorMaterials.SILVER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings()));
    public static final RegistrySupplier<Item> SILVER_LEGGINGS = register("armor_silver_metal_leggings", () -> new ArmorItem(IafArmorMaterials.SILVER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings()));
    public static final RegistrySupplier<Item> SILVER_BOOTS = register("armor_silver_metal_boots", () -> new ArmorItem(IafArmorMaterials.SILVER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings()));
    ...
    public static final RegistrySupplier<Item> COPPER_HELMET = register("armor_copper_metal_helmet", () -> new ArmorItem(IafArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings()));
    public static final RegistrySupplier<Item> COPPER_CHESTPLATE = register("armor_copper_metal_chestplate", () -> new ArmorItem(IafArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings()));
    public static final RegistrySupplier<Item> COPPER_LEGGINGS = register("armor_copper_metal_leggings", () -> new ArmorItem(IafArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings()));
    public static final RegistrySupplier<Item> COPPER_BOOTS = register("armor_copper_metal_boots", () -> new ArmorItem(IafArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings()));
    ...
    public static final RegistrySupplier<Item> SHEEP_HELMET = register("sheep_helmet", () -> new ItemModArmor(IafArmorMaterials.SHEEP_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> SHEEP_CHESTPLATE = register("sheep_chestplate", () -> new ItemModArmor(IafArmorMaterials.SHEEP_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> SHEEP_LEGGINGS = register("sheep_leggings", () -> new ItemModArmor(IafArmorMaterials.SHEEP_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> SHEEP_BOOTS = register("sheep_boots", () -> new ItemModArmor(IafArmorMaterials.SHEEP_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    ...
    public static final RegistrySupplier<Item> EARPLUGS = register("earplugs", () -> new ItemModArmor(IafArmorMaterials.EARPLUGS_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    ...
    public static final RegistrySupplier<Item> DEATHWORM_YELLOW_HELMET = register("deathworm_yellow_helmet", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_YELLOW_CHESTPLATE = register("deathworm_yellow_chestplate", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_YELLOW_LEGGINGS = register("deathworm_yellow_leggings", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_YELLOW_BOOTS = register("deathworm_yellow_boots", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_WHITE_HELMET = register("deathworm_white_helmet", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_WHITE_CHESTPLATE = register("deathworm_white_chestplate", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_WHITE_LEGGINGS = register("deathworm_white_leggings", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_WHITE_BOOTS = register("deathworm_white_boots", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_RED_HELMET = register("deathworm_red_helmet", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_RED_CHESTPLATE = register("deathworm_red_chestplate", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_RED_LEGGINGS = register("deathworm_red_leggings", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings()));
    public static final RegistrySupplier<Item> DEATHWORM_RED_BOOTS = register("deathworm_red_boots", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings()));
    ...
    public static final RegistrySupplier<Item> MYRMEX_DESERT_HELMET = register("myrmex_desert_helmet", () -> new ItemModArmor(IafArmorMaterials.MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_CHESTPLATE = register("myrmex_desert_chestplate", () -> new ItemModArmor(IafArmorMaterials.MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_LEGGINGS = register("myrmex_desert_leggings", () -> new ItemModArmor(IafArmorMaterials.MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_BOOTS = register("myrmex_desert_boots", () -> new ItemModArmor(IafArmorMaterials.MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_HELMET = register("myrmex_jungle_helmet", () -> new ItemModArmor(IafArmorMaterials.MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_CHESTPLATE = register("myrmex_jungle_chestplate", () -> new ItemModArmor(IafArmorMaterials.MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_LEGGINGS = register("myrmex_jungle_leggings", () -> new ItemModArmor(IafArmorMaterials.MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_BOOTS = register("myrmex_jungle_boots", () -> new ItemModArmor(IafArmorMaterials.MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    ...
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_HELMET = register("dragonsteel_fire_helmet", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_FIRE_ARMOR_MATERIAL, 0, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_CHESTPLATE = register("dragonsteel_fire_chestplate", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_FIRE_ARMOR_MATERIAL, 1, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_LEGGINGS = register("dragonsteel_fire_leggings", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_FIRE_ARMOR_MATERIAL, 2, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_BOOTS = register("dragonsteel_fire_boots", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_FIRE_ARMOR_MATERIAL, 3, ArmorItem.Type.BOOTS));
    ...
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_HELMET = register("dragonsteel_ice_helmet", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_ICE_ARMOR_MATERIAL, 0, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_CHESTPLATE = register("dragonsteel_ice_chestplate", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_ICE_ARMOR_MATERIAL, 1, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_LEGGINGS = register("dragonsteel_ice_leggings", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_ICE_ARMOR_MATERIAL, 2, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_BOOTS = register("dragonsteel_ice_boots", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_ICE_ARMOR_MATERIAL, 3, ArmorItem.Type.BOOTS));
    ...
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_HELMET = register("dragonsteel_lightning_helmet", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL, 0, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_CHESTPLATE = register("dragonsteel_lightning_chestplate", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL, 1, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_LEGGINGS = register("dragonsteel_lightning_leggings", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL, 2, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_BOOTS = register("dragonsteel_lightning_boots", () -> new ItemDragonSteelArmor(IafArmorMaterials.DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL, 3, ArmorItem.Type.BOOTS));
