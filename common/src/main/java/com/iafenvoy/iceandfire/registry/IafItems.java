...
public final class IafItems {
    ...
    public static final RegistrySupplier<Item> MYRMEX_DESERT_SWORD = register("myrmex_desert_sword", () -> new ItemModSword(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_SWORD_VENOM = register("myrmex_desert_sword_venom", () -> new ItemModSword(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_SHOVEL = register("myrmex_desert_shovel", () -> new ItemModShovel(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_PICKAXE = register("myrmex_desert_pickaxe", () -> new ItemModPickaxe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_AXE = register("myrmex_desert_axe", () -> new ItemModAxe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_HOE = register("myrmex_desert_hoe", () -> new ItemModHoe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_SWORD = register("myrmex_jungle_sword", () -> new ItemModSword(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_SWORD_VENOM = register("myrmex_jungle_sword_venom", () -> new ItemModSword(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_SHOVEL = register("myrmex_jungle_shovel", () -> new ItemModShovel(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_PICKAXE = register("myrmex_jungle_pickaxe", () -> new ItemModPickaxe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_AXE = register("myrmex_jungle_axe", () -> new ItemModAxe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_HOE = register("myrmex_jungle_hoe", () -> new ItemModHoe(MYRMEX_CHITIN_TOOL_MATERIAL));
    ...
    public static final RegistrySupplier<Item> MYRMEX_DESERT_HELMET = register("myrmex_desert_helmet", () -> new ItemModArmor(MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_CHESTPLATE = register("myrmex_desert_chestplate", () -> new ItemModArmor(MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_LEGGINGS = register("myrmex_desert_leggings", () -> new ItemModArmor(MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> MYRMEX_DESERT_BOOTS = register("myrmex_desert_boots", () -> new ItemModArmor(MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_HELMET = register("myrmex_jungle_helmet", () -> new ItemModArmor(MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_CHESTPLATE = register("myrmex_jungle_chestplate", () -> new ItemModArmor(MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_LEGGINGS = register("myrmex_jungle_leggings", () -> new ItemModArmor(MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> MYRMEX_JUNGLE_BOOTS = register("myrmex_jungle_boots", () -> new ItemModArmor(MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    ...
    public static void init() {
        ...
        IafItems.MYRMEX_CHITIN_TOOL_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItems.MYRMEX_DESERT_CHITIN.get()));
        IafItems.MYRMEX_DESERT_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItems.MYRMEX_DESERT_CHITIN.get()));
        IafItems.MYRMEX_JUNGLE_ARMOR_MATERIAL.setRepairMaterial(Ingredient.ofItems(IafItems.MYRMEX_JUNGLE_CHITIN.get()));
