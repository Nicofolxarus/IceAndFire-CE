...
public final class IafItems {
    ...
    public static final RegistrySupplier<Item> MANUSCRIPT = registerItem("manuscript", GenericItem::new);
    public static final RegistrySupplier<Item> SAPPHIRE_GEM = registerItem("sapphire_gem", GenericItem::new);
    public static final RegistrySupplier<Item> SILVER_INGOT = registerItem("silver_ingot", GenericItem::new);
    public static final RegistrySupplier<Item> SILVER_NUGGET = registerItem("silver_nugget", GenericItem::new);
    public static final RegistrySupplier<Item> RAW_SILVER = registerItem("raw_silver", GenericItem::new);
    public static final RegistrySupplier<Item> COPPER_NUGGET = registerItem("copper_nugget", GenericItem::new);
    public static final RegistrySupplier<Item> FIRE_STEW = registerItem("fire_stew", GenericItem::new);
    public static final RegistrySupplier<Item> FROST_STEW = registerItem("frost_stew", GenericItem::new);
    public static final RegistrySupplier<Item> LIGHTNING_STEW = registerItem("lightning_stew", GenericItem::new);
    ...
    public static final RegistrySupplier<Item> WITHERBONE = registerItem("witherbone", GenericItem::new);
    public static final RegistrySupplier<Item> WITHER_SHARD = registerItem("wither_shard", GenericItem::new);
    ...
    public static final RegistrySupplier<Item> DRAGON_MEAL = registerItem("dragon_meal", GenericItem::new);
    ...
    public static final RegistrySupplier<Item> FIRE_DRAGON_FLESH = registerItem(DragonFleshItem.getNameForType(0), () -> new DragonFleshItem(0));
    public static final RegistrySupplier<Item> ICE_DRAGON_FLESH = registerItem(DragonFleshItem.getNameForType(1), () -> new DragonFleshItem(1));
    public static final RegistrySupplier<Item> LIGHTNING_DRAGON_FLESH = registerItem(DragonFleshItem.getNameForType(2), () -> new DragonFleshItem(2));
    public static final RegistrySupplier<Item> FIRE_DRAGON_HEART = registerItem("fire_dragon_heart", GenericItem::new);
    public static final RegistrySupplier<Item> ICE_DRAGON_HEART = registerItem("ice_dragon_heart", GenericItem::new);
    public static final RegistrySupplier<Item> LIGHTNING_DRAGON_HEART = registerItem("lightning_dragon_heart", GenericItem::new);
    public static final RegistrySupplier<Item> FIRE_DRAGON_BLOOD = registerItem("fire_dragon_blood", GenericItem::new);
    public static final RegistrySupplier<Item> ICE_DRAGON_BLOOD = registerItem("ice_dragon_blood", GenericItem::new);
    public static final RegistrySupplier<Item> LIGHTNING_DRAGON_BLOOD = registerItem("lightning_dragon_blood", GenericItem::new);
    ...
    public static final RegistrySupplier<Item> IRON_HIPPOGRYPH_ARMOR = registerItem("iron_hippogryph_armor", () -> new GenericItem(0, 1));
    public static final RegistrySupplier<Item> GOLD_HIPPOGRYPH_ARMOR = registerItem("gold_hippogryph_armor", () -> new GenericItem(0, 1));
    public static final RegistrySupplier<Item> DIAMOND_HIPPOGRYPH_ARMOR = registerItem("diamond_hippogryph_armor", () -> new GenericItem(0, 1));
    public static final RegistrySupplier<Item> NETHERITE_HIPPOGRYPH_ARMOR = registerItem("netherite_hippogryph_armor", () -> new GenericItem(0, 1, true));
    ...
    public static final RegistrySupplier<Item> PIXIE_DUST = registerItem("pixie_dust", PixieDustItem::new);
    public static final RegistrySupplier<Item> PIXIE_WINGS = registerItem("pixie_wings", () -> new GenericItem(1));
    public static final RegistrySupplier<Item> AMBROSIA = registerItem("ambrosia", AmbrosiaItem::new);
    public static final RegistrySupplier<Item> SHINY_SCALES = registerItem("shiny_scales", GenericItem::new);
    ...
    public static final RegistrySupplier<Item> EARPLUGS = registerItem("earplugs", () -> new ModArmorItem(IafArmorMaterials.EARPLUGS_ARMOR_MATERIAL, ArmorItem.Type.HELMET, 55));
    public static final RegistrySupplier<Item> DEATH_WORM_CHITIN_YELLOW = registerItem("deathworm_chitin_yellow", GenericItem::new);
    public static final RegistrySupplier<Item> DEATH_WORM_CHITIN_WHITE = registerItem("deathworm_chitin_white", GenericItem::new);
    public static final RegistrySupplier<Item> DEATH_WORM_CHITIN_RED = registerItem("deathworm_chitin_red", GenericItem::new);
    ...
    public static final RegistrySupplier<Item> STYMPHALIAN_BIRD_FEATHER = registerItem("stymphalian_bird_feather", GenericItem::new);
    public static final RegistrySupplier<Item> TROLL_TUSK = registerItem("troll_tusk", GenericItem::new);
    public static final RegistrySupplier<Item> AMPHITHERE_FEATHER = registerItem("amphithere_feather", GenericItem::new);
    public static final RegistrySupplier<Item> AMPHITHERE_ARROW = registerItem("amphithere_arrow", AmphithereArrowItem::new);
    public static final RegistrySupplier<Item> SERPENT_FANG = registerItem("sea_serpent_fang", GenericItem::new);
    public static final RegistrySupplier<Item> SEA_SERPENT_ARROW = registerItem("sea_serpent_arrow", SeaSerpentArrowItem::new);
    public static final RegistrySupplier<Item> TIDE_TRIDENT_INVENTORY = register("tide_trident_inventory", () -> new GenericItem(0, true));
    ...
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_INGOT = registerItem("dragonsteel_fire_ingot", GenericItem::new);
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_INGOT = registerItem("dragonsteel_ice_ingot", GenericItem::new);
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_INGOT = registerItem("dragonsteel_lightning_ingot", GenericItem::new);
    public static final RegistrySupplier<Item> WEEZER_BLUE_ALBUM = registerItem("weezer_blue_album", () -> new GenericItem(1, true));
    public static final RegistrySupplier<Item> DRAGON_DEBUG_STICK = registerItem("dragon_debug_stick", () -> new GenericItem(1, true));
    public static final RegistrySupplier<Item> DREAD_SHARD = registerItem("dread_shard", () -> new GenericItem(0));
    public static final RegistrySupplier<Item> DREAD_KEY = registerItem("dread_key", () -> new GenericItem(0));
    public static final RegistrySupplier<Item> HYDRA_FANG = registerItem("hydra_fang", () -> new GenericItem(0));
    ...
    public static final RegistrySupplier<Item> ECTOPLASM = registerItem("ectoplasm", GenericItem::new);
    ...
    //Armors
    public static final RegistrySupplier<Item> SILVER_HELMET = registerArmor("armor_silver_metal_helmet", () -> new ArmorItem(IafArmorMaterials.SILVER_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(165)));
    public static final RegistrySupplier<Item> SILVER_CHESTPLATE = registerArmor("armor_silver_metal_chestplate", () -> new ArmorItem(IafArmorMaterials.SILVER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(240)));
    public static final RegistrySupplier<Item> SILVER_LEGGINGS = registerArmor("armor_silver_metal_leggings", () -> new ArmorItem(IafArmorMaterials.SILVER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(225)));
    public static final RegistrySupplier<Item> SILVER_BOOTS = registerArmor("armor_silver_metal_boots", () -> new ArmorItem(IafArmorMaterials.SILVER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(195)));
    public static final RegistrySupplier<Item> COPPER_HELMET = registerArmor("armor_copper_metal_helmet", () -> new ArmorItem(IafArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(111)));
    public static final RegistrySupplier<Item> COPPER_CHESTPLATE = registerArmor("armor_copper_metal_chestplate", () -> new ArmorItem(IafArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(161)));
    public static final RegistrySupplier<Item> COPPER_LEGGINGS = registerArmor("armor_copper_metal_leggings", () -> new ArmorItem(IafArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(151)));
    public static final RegistrySupplier<Item> COPPER_BOOTS = registerArmor("armor_copper_metal_boots", () -> new ArmorItem(IafArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(131)));
    public static final RegistrySupplier<Item> SHEEP_HELMET = registerArmor("sheep_helmet", () -> new ModArmorItem(IafArmorMaterials.SHEEP_ARMOR_MATERIAL, ArmorItem.Type.HELMET, 55));
    public static final RegistrySupplier<Item> SHEEP_CHESTPLATE = registerArmor("sheep_chestplate", () -> new ModArmorItem(IafArmorMaterials.SHEEP_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, 80));
    public static final RegistrySupplier<Item> SHEEP_LEGGINGS = registerArmor("sheep_leggings", () -> new ModArmorItem(IafArmorMaterials.SHEEP_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, 75));
    public static final RegistrySupplier<Item> SHEEP_BOOTS = registerArmor("sheep_boots", () -> new ModArmorItem(IafArmorMaterials.SHEEP_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, 65));
    public static final RegistrySupplier<Item> DEATHWORM_YELLOW_HELMET = registerArmor("deathworm_yellow_helmet", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(165)));
    public static final RegistrySupplier<Item> DEATHWORM_YELLOW_CHESTPLATE = registerArmor("deathworm_yellow_chestplate", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(240)));
    public static final RegistrySupplier<Item> DEATHWORM_YELLOW_LEGGINGS = registerArmor("deathworm_yellow_leggings", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(225)));
    public static final RegistrySupplier<Item> DEATHWORM_YELLOW_BOOTS = registerArmor("deathworm_yellow_boots", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(195)));
    public static final RegistrySupplier<Item> DEATHWORM_WHITE_HELMET = registerArmor("deathworm_white_helmet", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(165)));
    public static final RegistrySupplier<Item> DEATHWORM_WHITE_CHESTPLATE = registerArmor("deathworm_white_chestplate", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(240)));
    public static final RegistrySupplier<Item> DEATHWORM_WHITE_LEGGINGS = registerArmor("deathworm_white_leggings", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(225)));
    public static final RegistrySupplier<Item> DEATHWORM_WHITE_BOOTS = registerArmor("deathworm_white_boots", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(165)));
    public static final RegistrySupplier<Item> DEATHWORM_RED_HELMET = registerArmor("deathworm_red_helmet", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(165)));
    public static final RegistrySupplier<Item> DEATHWORM_RED_CHESTPLATE = registerArmor("deathworm_red_chestplate", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(240)));
    public static final RegistrySupplier<Item> DEATHWORM_RED_LEGGINGS = registerArmor("deathworm_red_leggings", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(225)));
    public static final RegistrySupplier<Item> DEATHWORM_RED_BOOTS = registerArmor("deathworm_red_boots", () -> new ArmorItem(IafArmorMaterials.DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(165)));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_HELMET = registerArmor("dragonsteel_fire_helmet", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_FIRE_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_CHESTPLATE = registerArmor("dragonsteel_fire_chestplate", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_FIRE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_LEGGINGS = registerArmor("dragonsteel_fire_leggings", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_FIRE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_BOOTS = registerArmor("dragonsteel_fire_boots", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_FIRE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_HELMET = registerArmor("dragonsteel_ice_helmet", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_ICE_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_CHESTPLATE = registerArmor("dragonsteel_ice_chestplate", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_ICE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_LEGGINGS = registerArmor("dragonsteel_ice_leggings", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_ICE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_BOOTS = registerArmor("dragonsteel_ice_boots", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_ICE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_HELMET = registerArmor("dragonsteel_lightning_helmet", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_CHESTPLATE = registerArmor("dragonsteel_lightning_chestplate", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_LEGGINGS = registerArmor("dragonsteel_lightning_leggings", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_BOOTS = registerArmor("dragonsteel_lightning_boots", () -> new DragonSteelArmorItem(IafArmorMaterials.DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    //Tools&Weapons
