...
public class ParticleDragonFrost extends SpriteBillboardParticle {
    protected ParticleDragonFrost(DragonFrostParticleType params, ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, SpriteProvider provider) {
    ...
    public record Provider(SpriteProvider spriteSet) implements ParticleFactory<DragonFrostParticleType> {
        ...
        public Particle createParticle(DragonFrostParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new ParticleDragonFrost(typeIn, worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
        }
    }
}
