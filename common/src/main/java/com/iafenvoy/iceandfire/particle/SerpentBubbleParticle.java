...
public class SerpentBubbleParticle extends SpriteBillboardParticle {
    private static final Identifier BUBBLE_TEXTURE = Identifier.of(IceAndFire.MOD_ID, "textures/particle/sea_serpent_bubble.png");

    public SerpentBubbleParticle(ClientWorld world, double x, double y, double z, double motX, double motY, double motZ, float size) {
