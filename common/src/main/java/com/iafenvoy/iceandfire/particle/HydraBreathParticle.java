...
public class HydraBreathParticle extends SpriteBillboardParticle {
    private static final Identifier HYDRA_POISON = Identifier.of(IceAndFire.MOD_ID, "textures/particle/hydra_poison.png");
    final float reddustParticleScale;

    public HydraBreathParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, float p_i46349_8_, float p_i46349_9_, float p_i46349_10_) {
        this(worldIn, xCoordIn, yCoordIn, zCoordIn, 1F, p_i46349_8_, p_i46349_9_, p_i46349_10_);
    }

    protected HydraBreathParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, float scale, float red, float green, float blue) {
