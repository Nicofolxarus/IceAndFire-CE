...
public class PixieDustParticle extends SpriteBillboardParticle {
    private static final Identifier PIXIE_DUST = Identifier.of(IceAndFire.MOD_ID, "textures/particle/pixie_dust.png");
    final float reddustParticleScale;

    public PixieDustParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, float p_i46349_8_, float p_i46349_9_, float p_i46349_10_) {
        this(worldIn, xCoordIn, yCoordIn, zCoordIn, 1F, p_i46349_8_, p_i46349_9_, p_i46349_10_);
    }

    public PixieDustParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, float scale, float red, float green, float blue) {
