...
public class ParticleDragonFlame extends SpriteBillboardParticle {
    public ParticleDragonFlame(DragonFlameParticleType params, ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, SpriteProvider provider) {
