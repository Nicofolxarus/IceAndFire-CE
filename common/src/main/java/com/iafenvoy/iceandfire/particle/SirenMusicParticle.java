...
public class SirenMusicParticle extends SpriteBillboardParticle {
    private static final Identifier SIREN_MUSIC = Identifier.of(IceAndFire.MOD_ID, "textures/particle/siren_music.png");
    float colorScale;

    public SirenMusicParticle(ClientWorld world, double x, double y, double z, double motX, double motY, double motZ) {
