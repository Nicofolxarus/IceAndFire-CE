...
public class RenderGorgon extends MobEntityRenderer<EntityGorgon, ModelGorgon> {
    public static final Identifier PASSIVE_TEXTURE = Identifier.of(IceAndFire.MOD_ID, "textures/models/gorgon/gorgon_passive.png");
    public static final Identifier AGRESSIVE_TEXTURE = Identifier.of(IceAndFire.MOD_ID, "textures/models/gorgon/gorgon_active.png");
    public static final Identifier DEAD_TEXTURE = Identifier.of(IceAndFire.MOD_ID, "textures/models/gorgon/gorgon_decapitated.png");
