...
public class LightningDragonEntityRenderer extends DragonBaseEntityRenderer {
    ...
    @Override
    public boolean shouldRender(DragonBaseEntity livingEntityIn, Frustum camera, double camX, double camY, double camZ) {
        if (super.shouldRender(livingEntityIn, camera, camX, camY, camZ))
            return true;
        else {
            LightningDragonEntity lightningDragon = (LightningDragonEntity) livingEntityIn;
    ...
    @Override
    public void render(DragonBaseEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn) {
        super.render(entityIn, entityYaw, partialTicks, matrixStackIn, bufferIn, packedLightIn);
        LightningDragonEntity lightningDragon = (LightningDragonEntity) entityIn;
        matrixStackIn.push();
        if (lightningDragon.hasLightningTarget()) {
