...
public class LightningTabulaDragonAnimator extends DragonTabulaModelAnimator {
    public LightningTabulaDragonAnimator() {
        super(DragonAnimationsLibrary.getModel(DragonPoses.GROUND_POSE, DragonModelTypes.LIGHTNING_DRAGON_MODEL));
    ...
    protected TabulaModel<DragonBaseEntity> getModelInternal(DragonPoses pose) {
        return DragonAnimationsLibrary.getModel(pose, DragonModelTypes.LIGHTNING_DRAGON_MODEL);
    }
}
