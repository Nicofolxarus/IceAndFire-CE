...
public class RenderDreadHorse extends MobEntityRenderer<EntityDreadHorse, HorseEntityModel<EntityDreadHorse>> {
    public static final Identifier TEXTURE = Identifier.of(IceAndFire.MOD_ID, "textures/models/dread/dread_knight_horse.png");
    public static final Identifier TEXTURE_EYES = Identifier.of(IceAndFire.MOD_ID, "textures/models/dread/dread_knight_horse_eyes.png");
