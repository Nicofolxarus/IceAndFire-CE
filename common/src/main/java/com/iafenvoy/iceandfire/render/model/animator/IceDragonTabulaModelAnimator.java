...
public class IceDragonTabulaModelAnimator extends DragonTabulaModelAnimator {
    public IceDragonTabulaModelAnimator() {
        super(DragonAnimationsLibrary.getModel(DragonPoses.GROUND_POSE, DragonModelTypes.ICE_DRAGON_MODEL));
    ...
    protected TabulaModel<DragonBaseEntity> getModelInternal(DragonPoses pose) {
        return DragonAnimationsLibrary.getModel(pose, DragonModelTypes.ICE_DRAGON_MODEL);
    }
}
