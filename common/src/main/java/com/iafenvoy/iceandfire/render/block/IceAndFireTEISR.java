...
public class IceAndFireTEISR extends BuiltinModelItemRenderer {
    ...
    private final BlockEntityGhostChest chest = new BlockEntityGhostChest(BlockPos.ORIGIN, IafBlocks.GHOST_CHEST.get().getDefaultState());
    private final BlockEntityDreadPortal portal = new BlockEntityDreadPortal(BlockPos.ORIGIN, IafBlocks.DREAD_PORTAL.get().getDefaultState());
