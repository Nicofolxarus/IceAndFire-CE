...
public class BipedArmorFeatureRenderer<T extends LivingEntity & IAnimatedEntity, M extends BipedBaseModel<T>, A extends BipedBaseModel<T>> extends FeatureRenderer<T, M> {
    ...
    public BipedArmorFeatureRenderer(FeatureRendererContext<T, M> mobRenderer, A modelLeggings, A modelArmor, Identifier defaultArmor, Identifier defaultLegArmor) {
        super(mobRenderer);
