...
public class ItemDeathwormEgg extends Item implements ProjectileItem {
    ...
    public TypedActionResult<ItemStack> use(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        if (!worldIn.isClient) {
            EntityDeathWormEgg entityegg = new EntityDeathWormEgg(IafEntities.DEATH_WORM_EGG.get(), playerIn, worldIn, this.gigantic);
    ...
    public ProjectileEntity createEntity(World world, Position pos, ItemStack stack, Direction direction) {
        return new EntityDeathWormEgg(IafEntities.DEATH_WORM_EGG.get(), pos.getX(), pos.getY(), pos.getZ(), world, this.gigantic);
    }
}
