...
public class LecternBlock extends BlockWithEntity {
    private static final MapCodec<? extends BlockWithEntity> CODEC = createCodec(s -> new LecternBlock());
    ...
    public void onStateReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
        ...
        if (blockEntity instanceof LecternBlockEntity) {
            ItemScatterer.spawn(worldIn, pos, (LecternBlockEntity) blockEntity);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> entityType) {
        return world.isClient ? validateTicker(entityType, IafBlockEntities.IAF_LECTERN.get(), LecternBlockEntity::bookAnimationTick) : null;
    }
