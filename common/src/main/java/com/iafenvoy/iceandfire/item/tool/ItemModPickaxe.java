...
//    }
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> bakeDragonsteel() {
        if (this.getMaterial().getAttackDamage() != IafCommonConfig.INSTANCE.armors.dragonSteelBaseDamage.getValue().floatValue() || this.dragonsteelModifiers == null) {
            ...
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE.value(), new EntityAttributeModifier(Identifier.of(IceAndFire.MOD_ID, "pickaxe"), IafCommonConfig.INSTANCE.armors.dragonSteelBaseDamage.getValue() - 1F + 1F, EntityAttributeModifier.Operation.ADD_VALUE));
            builder.put(EntityAttributes.GENERIC_ATTACK_SPEED.value(), new EntityAttributeModifier(Identifier.of(IceAndFire.MOD_ID, "pickaxe"), -2.8F, EntityAttributeModifier.Operation.ADD_VALUE));
