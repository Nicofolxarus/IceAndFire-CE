...
public class DragonForgeBrickBlockEntity extends BlockEntity implements SidedInventory {
    @Nullable
    ...
    public static void tick(final World level, final BlockPos position, final BlockState state, final DragonForgeBrickBlockEntity forgeInput) {
