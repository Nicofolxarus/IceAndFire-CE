...
public class StymphalianBirdAIFleeGoal extends Goal {
    ...
    public StymphalianBirdAIFleeGoal(StymphalianBirdEntity stymphalianBird, float avoidDistanceIn) {
        ...
        this.canBeSeenSelector = entity -> entity instanceof PlayerEntity && entity.isAlive() && StymphalianBirdAIFleeGoal.this.stymphalianBird.getVisibilityCache().canSee(entity) && !StymphalianBirdAIFleeGoal.this.stymphalianBird.isTeammate(entity);
