...
public class DreadKnightEntity extends DreadMobEntity implements IAnimatedEntity, IVillagerFear, IAnimalFear {
    ...
    private static final TrackedData<Integer> VARIANT = DataTracker.registerData(DreadKnightEntity.class, TrackedDataHandlerRegistry.INTEGER);
    private int animationTick;
    private Animation currentAnimation;

    public DreadKnightEntity(EntityType<? extends DreadKnightEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected void initGoals() {
        this.goalSelector.add(0, new DreadAIRideHorseGoal(this));
