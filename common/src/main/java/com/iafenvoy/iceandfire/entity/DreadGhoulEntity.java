...
public class DreadGhoulEntity extends DreadMobEntity implements IAnimatedEntity, IVillagerFear, IAnimalFear {
    ...
    private static final TrackedData<Float> SCALE = DataTracker.registerData(DreadGhoulEntity.class, TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Integer> VARIANT = DataTracker.registerData(DreadGhoulEntity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<Integer> SCREAMS = DataTracker.registerData(DreadGhoulEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    public DreadGhoulEntity(EntityType<? extends DreadGhoulEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(3, new DreadAITargetNonDreadGoal(this, LivingEntity.class, false, (Predicate<LivingEntity>) DragonUtils::canHostilesTarget));
    }
