...
public class AquaticAIGetInWaterGoal extends Goal {
    ...
    public AquaticAIGetInWaterGoal(MobEntity theCreatureIn, double movementSpeedIn) {
    ...
    public boolean canStart() {
        if (this.creature.hasPassengers() || this.creature instanceof TameableEntity tameable && tameable.isTamed()
                || this.creature.isTouchingWater() || this.isAttackerInWater() || this.creature instanceof SirenEntity siren
