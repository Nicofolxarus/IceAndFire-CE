...
public class EntitySheepAIFollowCyclopsGoal extends Goal {
    ...
    public EntitySheepAIFollowCyclopsGoal(AnimalEntity animal, double speed) {
    ...
    public boolean canStart() {
        List<CyclopsEntity> list = this.childAnimal.getWorld().getNonSpectatingEntities(CyclopsEntity.class, this.childAnimal.getBoundingBox().expand(16.0D, 8.0D, 16.0D));
    ...
    public Path getPathToLivingEntity(AnimalEntity entityIn, CyclopsEntity cyclops) {
