...
public class SeaSerpentEntity extends AnimalEntity implements IAnimatedEntity, IMultipartEntity, IVillagerFear, IAnimalFear, IHasCustomizableAttributes {
    ...
    private static final TrackedData<String> VARIANT = DataTracker.registerData(SeaSerpentEntity.class, TrackedDataHandlerRegistry.STRING);
    private static final TrackedData<Float> SCALE = DataTracker.registerData(SeaSerpentEntity.class, TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Boolean> JUMPING = DataTracker.registerData(SeaSerpentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<Boolean> BREATHING = DataTracker.registerData(SeaSerpentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<Boolean> ANCIENT = DataTracker.registerData(SeaSerpentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public SeaSerpentEntity(EntityType<SeaSerpentEntity> t, World worldIn) {
        super(t, worldIn);
    ...
    protected void initGoals() {
        this.goalSelector.add(0, new SeaSerpentAIGetInWaterGoal(this));
        this.goalSelector.add(1, new SeaSerpentAIMeleeJumpGoal(this));
        this.goalSelector.add(1, new SeaSerpentAIAttackMeleeGoal(this, 1.0D, true));
        this.goalSelector.add(2, new SeaSerpentAIRandomSwimmingGoal(this, 1.0D, 2));
        this.goalSelector.add(3, new SeaSerpentAIJumpGoal(this, 4));
        this.goalSelector.add(4, new LookAroundGoal(this));
        this.goalSelector.add(5, new LookAtEntityGoal(this, PlayerEntity.class, 6.0F));
        this.targetSelector.add(1, new RevengeGoal(this, MultipartPartEntity.class).setGroupRevenge());
        this.targetSelector.add(2, new FlyingAITargetGoal<>(this, LivingEntity.class, 150, false, false, entity1 -> !(entity1 instanceof SeaSerpentEntity) && DragonUtils.isAlive(entity1) && entity1.isInsideWaterOrBubbleColumn()));
        this.targetSelector.add(3, new FlyingAITargetGoal<>(this, PlayerEntity.class, 0, false, false, entity -> !(entity instanceof SeaSerpentEntity) && DragonUtils.isAlive(entity)));
    }
    ...
    public void tickCramming() {
        ...
        entities.stream().filter(entity -> !(entity instanceof MultipartPartEntity) && entity.isPushable()).forEach(entity -> entity.pushAwayFrom(this));
    }
    ...
    private void switchNavigator(boolean onLand) {
        if (onLand) {
            ...
            this.navigation = new SeaSerpentPathNavigatorGoal(this, this.getWorld());
    ...
    private void doSplashDamage() {
        ...
        List<Entity> list = this.getWorld().getOtherEntities(this, this.getBoundingBox().expand(getWidth, getWidth * 0.5D, getWidth), entity -> entity instanceof LivingEntity living && !(entity instanceof SeaSerpentEntity) && DragonUtils.isAlive(living));
        ...
        if (!this.attackDecision) {
            ...
            if (this.isBreathing()) {
                ...
                if (this.age % 10 == 0) {
                    ...
                    SeaSerpentBubblesEntity entitylargefireball = new SeaSerpentBubblesEntity(IafEntities.SEA_SERPENT_BUBBLES.get(), this.getWorld(), this, d2, d3, d4);
