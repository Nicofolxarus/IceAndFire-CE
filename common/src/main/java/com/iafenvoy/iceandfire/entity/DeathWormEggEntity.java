...
public class DeathWormEggEntity extends ThrownItemEntity {
    private boolean giant;

    public DeathWormEggEntity(EntityType<? extends ThrownItemEntity> type, World worldIn) {
        super(type, worldIn);
    }

    public DeathWormEggEntity(EntityType<? extends ThrownItemEntity> type, LivingEntity throwerIn, World worldIn, boolean giant) {
        super(type, throwerIn, worldIn);
        this.giant = giant;
    }

    public DeathWormEggEntity(EntityType<? extends ThrownItemEntity> type, double x, double y, double z,
    ...
    protected void onCollision(HitResult result) {
        ...
        if (!this.getWorld().isClient) {
            ...
            DeathWormEntity deathworm = new DeathWormEntity(IafEntities.DEATH_WORM.get(), this.getWorld());
