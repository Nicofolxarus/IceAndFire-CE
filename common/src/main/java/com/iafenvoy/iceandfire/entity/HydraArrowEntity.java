...
public class HydraArrowEntity extends PersistentProjectileEntity {
    public HydraArrowEntity(EntityType<? extends PersistentProjectileEntity> t, World worldIn) {
        super(t, worldIn);
        this.setDamage(5F);
    }

    public HydraArrowEntity(EntityType<? extends PersistentProjectileEntity> t, World worldIn, double x, double y, double z) {
        this(t, worldIn);
    ...
    public HydraArrowEntity(EntityType<? extends HydraArrowEntity> t, World worldIn, LivingEntity shooter, ItemStack shotFrom) {
