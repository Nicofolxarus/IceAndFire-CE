...
public class StymphalianBirdEntity extends HostileEntity implements IAnimatedEntity, Monster, IVillagerFear, IAnimalFear {
    ...
    private static final TrackedData<Optional<UUID>> VICTOR_ENTITY = DataTracker.registerData(StymphalianBirdEntity.class, TrackedDataHandlerRegistry.OPTIONAL_UUID);
    private static final TrackedData<Boolean> FLYING = DataTracker.registerData(StymphalianBirdEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public StymphalianBirdEntity(EntityType<? extends HostileEntity> t, World worldIn) {
        super(t, worldIn);
    }
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new StymphalianBirdAIFleeGoal(this, 10));
        this.goalSelector.add(3, new MeleeAttackGoal(this, 1.5D, false));
        this.goalSelector.add(5, new WanderAroundFarGoal(this, 1.0D));
        this.goalSelector.add(6, new StymphalianBirdAIAirTargetGoal(this));
        this.goalSelector.add(7, new LookAtEntityGoal(this, LivingEntity.class, 6.0F));
        this.goalSelector.add(8, new LookAroundGoal(this));
        this.targetSelector.add(1, new RevengeGoal(this));
        this.targetSelector.add(2, new StymphalianBirdAITargetGoal(this, LivingEntity.class, true));
    }
                ...
                if (this.isFlying()) {
                    ...
                    if ((this.getAnimationTick() == 7 || this.getAnimationTick() == 14) && this.isDirectPathBetweenPoints(this, this.getPos(), target.getPos())) {
                        ...
                        for (int i = 0; i < 4; i++) {
                            ...
                            StymphalianFeatherEntity entityarrow = new StymphalianFeatherEntity(IafEntities.STYMPHALIAN_FEATHER.get(), this.getWorld(), this);
