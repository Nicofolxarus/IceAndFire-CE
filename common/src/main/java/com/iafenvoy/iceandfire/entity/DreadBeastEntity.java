...
public class DreadBeastEntity extends DreadMobEntity implements IAnimatedEntity, IVillagerFear, IAnimalFear {
    ...
    private static final TrackedData<Float> SCALE = DataTracker.registerData(DreadBeastEntity.class, TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Integer> VARIANT = DataTracker.registerData(DreadBeastEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    public DreadBeastEntity(EntityType<? extends DreadBeastEntity> type, World worldIn) {
        super(type, worldIn);
    }
