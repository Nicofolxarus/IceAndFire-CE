...
public class TrollEntity extends HostileEntity implements IAnimatedEntity, IVillagerFear, IHumanoid, IHasCustomizableAttributes {
    ...
    private static final TrackedData<String> VARIANT = DataTracker.registerData(TrollEntity.class, TrackedDataHandlerRegistry.STRING);
    private static final TrackedData<String> WEAPON = DataTracker.registerData(TrollEntity.class, TrackedDataHandlerRegistry.STRING);
    public float stoneProgress;
    private int animationTick;
    private Animation currentAnimation;
    private boolean avoidSun = true;

    public TrollEntity(EntityType<TrollEntity> t, World worldIn) {
        super(t, worldIn);
    }
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TrollAIFleeSunGoal(this, 1.0D));
