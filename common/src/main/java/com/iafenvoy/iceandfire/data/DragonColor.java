...
public record DragonColor(String name, Formatting color, DragonType dragonType, Supplier<Item> eggItem,
    ...
    public Identifier getBodyTexture(int stage) {
        return Identifier.of(IceAndFire.MOD_ID, String.format("textures/entity/%sdragon/%s_%d.png", this.dragonType.getName(), this.name, stage));
    }

    public Identifier getSleepTexture(int stage) {
        return Identifier.of(IceAndFire.MOD_ID, String.format("textures/entity/%sdragon/%s_%d_sleeping.png", this.dragonType.getName(), this.name, stage));
    }

    public Identifier getEyesTexture(int stage) {
        return Identifier.of(IceAndFire.MOD_ID, String.format("textures/entity/%sdragon/%s_%d_eyes.png", this.dragonType.getName(), this.name, stage));
    }

    public Identifier getSkeletonTexture(int stage) {
        return Identifier.of(IceAndFire.MOD_ID, String.format("textures/entity/%sdragon/%s_skeleton_%d.png", this.dragonType.getName(), this.dragonType.getName(), stage));
    }

    public Identifier getMaleOverlay() {
        return Identifier.of(IceAndFire.MOD_ID, String.format("textures/entity/%sdragon/male_%s.png", this.dragonType.getName(), this.name));
    }
}
