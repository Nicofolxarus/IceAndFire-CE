...
public class IafAttachments {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<PortalDataStorage>> PORTAL_DATA = register("portal_data", () -> AttachmentType.serializable(holder -> new PortalDataStorage(holder instanceof LivingEntity living ? living : null)).copyOnDeath().build());
